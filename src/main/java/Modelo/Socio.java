...
public class Socio implements Serializable {
    ...
    public Socio(String numeroSocio, String nombre, String dni, String fechaNacimiento, String telefono, String correo, String fechaEntrada, Character categoria, Set<Actividad> actividadSet) {
        this.numeroSocio = numeroSocio;
        this.nombre = nombre;
        this.dni = dni;
